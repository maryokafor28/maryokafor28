...
I care about the full picture: how data flows, how systems scale, and how to ship maintainable code backed by comprehensive testing. My foundation in Data Structures and Algorithms, Object-Oriented Programming, and software engineering best practices helps me write efficient, reliable code and approach problems with strong analytical thinking.
...
- **[WaveCom Notification Delivery System ](https://github.com/maryokafor28/wavecom-backend)** 🔗 **Live:** [http://wavecom.maryamadi.com](http://wavecom.maryamadi.com) *(HTTPS pending)* -A scalable, fault-tolerant notification delivery system for transactional notifications (email, SMS, and push), built with a stateless, horizontally-scaled API layer, async queue-based processing, and pluggable real provider integrations.
...
<p align="center">
  ...
  <a href="mailto:vincyokafor@gmail.com">
