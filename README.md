...
- **[WaveCom Notification Delivery System ](https://github.com/maryokafor28/wavecom-backend)** 🔗 **Live:** [https://wavecom.maryamadi.com](https://wavecom.maryamadi.com)  -A scalable, fault-tolerant notification delivery system for transactional notifications (email, SMS, and push), built with a stateless, horizontally-scaled API layer, async queue-based processing, and pluggable real provider integrations.
